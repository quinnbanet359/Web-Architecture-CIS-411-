        ...
        <table class="auto-style1">
            ...
            <tr>
                ...
                <td class="auto-style6">
                    <asp:RangeValidator ID="quantityValidator" runat="server" ControlToValidate="quantityTxt" ErrorMessage="Please enter a positive whole number" ForeColor="Red" MaximumValue="9999" MinimumValue="0" Type="Integer"></asp:RangeValidator>
                </td>
            </tr>
            <tr>
                <td class="auto-style5">
